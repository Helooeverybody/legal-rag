...
# Respect an existing HF_HOME if the user set one; otherwise fall back to the
# standard per-user HuggingFace cache. Set this before importing any library
# (e.g. sentence-transformers) that reads the cache location at import time.
